                    ...
                    if (strNewRole != "0")
                    {
...

                            {
                                ...
                                try
                                {
                                    using (SqlCommand command = new SqlCommand(
                                        "INSERT INTO Students VALUES(@ID, @UserName, @StudentIndex, @GPA, @Program, @Email)", con))
                                    {
                       ...
                       else if (strNewRole == "Professor")
                        {
...

                            {
                                ...
                                {
                                    using (SqlCommand command = new SqlCommand(
                                        "INSERT INTO Professors VALUES(@IDProf, @Name, @Surname, @Email)", con))
                                    {
                                        command.Parameters.Add(new SqlParameter("IDProf", objNewAdminUser.Id));
